...
uint32_t BTSendGetCommand(UART_MODULE uartID,uint8_t params[][BLUETOOTH_MAX_PARAM_LEN],uint8_t numParams,uint8_t commandResponse[][BLUETOOTH_MAX_COMMAND_RESPONSE_LEN],
